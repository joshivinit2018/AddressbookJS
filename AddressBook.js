...
set email(email) 
{
  ...
  if (emailRegex.test(email))
    ...
    toString()
    {
        return "Frist Name:" + this.fristName + ",Last Name:" + this.lastName + "\nAddress:" + this.address
...
try {
    let contact_book= new AddressBook("Vinit","Joshi","Ramnagar","Kagal","Maharashtra","416588","9874562130","Vintj12@gmail.com");
